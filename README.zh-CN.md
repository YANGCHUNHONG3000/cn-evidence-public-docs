...
**先看交付内容，再决定是否接入：** [可读的虚构核验示例](https://yangchunhong3000.github.io/cn-evidence-public-docs/sample-report.html)把查到的记录、未查模块和覆盖限制分开解释，无需钱包、不查询真实企业。页面中的核对建议是文档说明，不是新增自动风险判断功能。
